...
| 2026-08-28 | Glicko-2 sources use the same public-ladder gate as MGEMod and mge.tf (`rd < 100` and 10+ games). Panel still never writes ratings. Elo sources (NULL or missing `rd`) stay on raw-rating sort.                                                                                                                                                     |
