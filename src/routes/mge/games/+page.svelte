      ...
      <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
          ...
          <div>
            ...
            <select
              id="arenaSelect"
              class="w-full rounded-md border border-gray-200 bg-white px-2 py-2 text-sm text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200"
              value={arena}
          ...
          <div class="md:col-span-2">
            ...
            <div class="flex items-center gap-2 text-sm">
              <button
                class={`rounded-md px-2 py-1 ${outcome === 'all' ? 'bg-gray-200 text-gray-900 dark:bg-gray-800 dark:text-gray-100' : 'bg-transparent text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800'}`}
                onclick={() => (outcome = 'all')}>All</button>
              <button
                class={`rounded-md px-2 py-1 ${outcome === 'win' ? 'bg-gray-200 text-gray-900 dark:bg-gray-800 dark:text-gray-100' : 'bg-transparent text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800'}`}
                onclick={() => (outcome = 'win')}>Wins</button>
              <button
                class={`rounded-md px-2 py-1 ${outcome === 'loss' ? 'bg-gray-200 text-gray-900 dark:bg-gray-800 dark:text-gray-100' : 'bg-transparent text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800'}`}
          ...
          <div class="md:col-span-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
              ...
              <input
                id="fromDate"
                type="date"
                class="rounded-md border border-gray-200 bg-white px-2 py-1 text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200"
                value={dateFrom}
          ...
          <div class="flex items-center justify-end gap-2 md:col-span-3">
            <button class="w-full rounded-md bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-60 md:w-auto" onclick={() => applyFilters()}>Search</button>
          </div>
        </div>
      </div>
    </div>
